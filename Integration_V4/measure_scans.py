...
data=dict(revision='scans-2026-09-09',status='Releve nominal, non metrologique',mm_per_pixel=scale,nominal_dpi=200,estimated_edge_uncertainty_mm=.25,estimated_connector_position_uncertainty_mm=.5,departure_axis='Hypothese : retrait depuis petit bord, en attente de confirmation',screen=dict(length_mm=262.7,width_mm=10.8,thickness_mm=1.5,active_insets_mm=dict(left=10.5,right=1.2,top=1.5,bottom=1.0),active_size_mm=[251,8.3]),flex_thickness_mm=.15,Touch=touch,Display=display)
